...
export class OlympusApiServer {
  ...
  private registerRoutes(): void {
    this.routes.push(
      ...
      { method: "GET", pattern: "/v1/release-notes", handler: (_req, res) => res.json(200, { summary: this.olympus.releaseNotes.summary(), published: this.olympus.releaseNotes.publishedNotes() }) },
      { method: "GET", pattern: "/v1/beta-programs", handler: (_req, res) => res.json(200, { summary: this.olympus.betaProgram.summary(), open: this.olympus.betaProgram.listPrograms("open") }) },
      { method: "GET", pattern: "/v1/announcements", handler: (_req, res) => res.json(200, { summary: this.olympus.announcement.summary(), published: this.olympus.announcement.listAnnouncements("published").map(a => ({ id: a.id, title: a.title, audience: a.audience, priority: a.priority, reads: a.reads.size, acks: a.acks.size })) }) },
      ...
      { method: "GET", pattern: "/v1/credit-limits", handler: (_req, res) => res.json(200, { summary: this.olympus.creditLimit.summary(), lines: this.olympus.creditLimit.listLines() }) },
      { method: "GET", pattern: "/v1/loan-servicing", handler: (_req, res) => res.json(200, { summary: this.olympus.loanServicing.summary(), loans: this.olympus.loanServicing.listLoans() }) },
      { method: "GET", pattern: "/v1/payments", handler: (_req, res) => res.json(200, { summary: this.olympus.paymentGateway.summary(), payments: this.olympus.paymentGateway.listPayments() }) },
      { method: "GET", pattern: "/v1/refunds", handler: (_req, res) => res.json(200, { summary: this.olympus.refund.summary(), pending: this.olympus.refund.listRefunds("requested") }) },
      { method: "GET", pattern: "/v1/payouts", handler: (_req, res) => res.json(200, { summary: this.olympus.payout.summary(), scheduled: this.olympus.payout.listPayouts("scheduled") }) },
      { method: "GET", pattern: "/v1/reconciliation", handler: (_req, res) => res.json(200, { summary: this.olympus.reconciliation.summary() }) },
      { method: "GET", pattern: "/v1/pos-terminals", handler: (_req, res) => res.json(200, { summary: this.olympus.posTerminal.summary(), open: this.olympus.posTerminal.listSessions("open") }) },
      ...
      { method: "GET", pattern: "/v1/data-quality", handler: (_req, res) => res.json(200, { summary: this.olympus.dataQuality.summary(), rules: this.olympus.dataQuality.listRules() }) },
      { method: "GET", pattern: "/v1/schema-registry", handler: (_req, res) => res.json(200, { summary: this.olympus.schemaRegistry.summary(), subjects: this.olympus.schemaRegistry.listSubjects().map(x => ({ subject: x.subject, versions: x.versions.length, consumers: x.consumers.size })) }) },
      { method: "GET", pattern: "/v1/email-deliverability", handler: (_req, res) => res.json(200, { summary: this.olympus.emailDeliverability.summary() }) },
      { method: "GET", pattern: "/v1/push-campaigns", handler: (_req, res) => res.json(200, { summary: this.olympus.pushCampaign.summary() }) },
      { method: "GET", pattern: "/v1/in-app-messages", handler: (_req, res) => res.json(200, { summary: this.olympus.inAppMessage.summary() }) },
      { method: "GET", pattern: "/v1/banners", handler: (_req, res) => res.json(200, { summary: this.olympus.banner.summary(), scheduled: this.olympus.banner.listBanners(undefined, "scheduled") }) },
      { method: "GET", pattern: "/v1/gift-registries", handler: (_req, res) => res.json(200, { summary: this.olympus.giftRegistry.summary() }) },
      { method: "GET", pattern: "/v1/stores", handler: (_req, res) => res.json(200, { summary: this.olympus.storeLocator.summary(), stores: this.olympus.storeLocator.listStores(undefined, "open") }) },
      { method: "GET", pattern: "/v1/curbside", handler: (_req, res) => res.json(200, { summary: this.olympus.curbsidePickup.summary(), awaiting: this.olympus.curbsidePickup.listOrders("ready") }) },
      { method: "GET", pattern: "/v1/returns-portal", handler: (_req, res) => res.json(200, { summary: this.olympus.returnsPortal.summary(), open: this.olympus.returnsPortal.listReturns("requested") }) },
      { method: "GET", pattern: "/v1/trade-ins", handler: (_req, res) => res.json(200, { summary: this.olympus.tradeIn.summary(), tradeIns: this.olympus.tradeIn.listTradeIns() }) },
      { method: "GET", pattern: "/v1/price-match", handler: (_req, res) => res.json(200, { summary: this.olympus.priceMatch.summary(), pending: this.olympus.priceMatch.listClaims("submitted") }) },
      { method: "GET", pattern: "/v1/consignment", handler: (_req, res) => res.json(200, { summary: this.olympus.consignment.summary(), listed: this.olympus.consignment.listItems("listed") }) },
      { method: "GET", pattern: "/v1/rentals", handler: (_req, res) => res.json(200, { summary: this.olympus.rental.summary(), active: this.olympus.rental.listRentals("active") }) },
      { method: "GET", pattern: "/v1/wholesale", handler: (_req, res) => res.json(200, { summary: this.olympus.wholesale.summary(), open: this.olympus.wholesale.listOrders("placed") }) },
      { method: "GET", pattern: "/v1/franchise", handler: (_req, res) => res.json(200, { summary: this.olympus.franchise.summary(), unpaidRoyalties: this.olympus.franchise.listUnpaidRoyalties() }) },
      { method: "GET", pattern: "/v1/routes", handler: (_req, res) => res.json(200, { summary: this.olympus.routeOptimizer.summary(), active: this.olympus.routeOptimizer.listRoutes("in_progress") }) },
      { method: "GET", pattern: "/v1/sustainability", handler: (_req, res) => res.json(200, { summary: this.olympus.sustainability.summary() }) },
      { method: "GET", pattern: "/v1/parking", handler: (_req, res) => res.json(200, { summary: this.olympus.parking.summary(), spaces: this.olympus.parking.listSpaces() }) },
      { method: "GET", pattern: "/v1/mailroom", handler: (_req, res) => res.json(200, { summary: this.olympus.mailroom.summary(), awaiting: this.olympus.mailroom.listPackages("received") }) },
      { method: "GET", pattern: "/v1/mentorship", handler: (_req, res) => res.json(200, { summary: this.olympus.mentorship.summary(), active: this.olympus.mentorship.listPairings("active") }) },
      { method: "GET", pattern: "/v1/tuition", handler: (_req, res) => res.json(200, { summary: this.olympus.tuition.summary(), pending: this.olympus.tuition.listClaims("submitted") }) },
      { method: "GET", pattern: "/v1/wellness", handler: (_req, res) => res.json(200, { summary: this.olympus.wellness.summary() }) },
      { method: "GET", pattern: "/v1/sabbaticals", handler: (_req, res) => res.json(200, { summary: this.olympus.sabbatical.summary(), pending: this.olympus.sabbatical.listRequests("requested") }) },
      { method: "GET", pattern: "/v1/relocation", handler: (_req, res) => res.json(200, { summary: this.olympus.relocation.summary(), active: this.olympus.relocation.listPackages("active") }) },
      { method: "GET", pattern: "/v1/ergonomics", handler: (_req, res) => res.json(200, { summary: this.olympus.ergonomics.summary(), openIssues: this.olympus.ergonomics.openIssues() }) },
      { method: "GET", pattern: "/v1/ip-portfolio", handler: (_req, res) => res.json(200, { summary: this.olympus.ipPortfolio.summary(), active: this.olympus.ipPortfolio.listAssets(undefined, "active") }) },
      { method: "GET", pattern: "/v1/scholarships", handler: (_req, res) => res.json(200, { summary: this.olympus.scholarship.summary(), pending: this.olympus.scholarship.listApplications(undefined, "submitted") }) },
      { method: "GET", pattern: "/v1/cafeteria", handler: (_req, res) => res.json(200, { summary: this.olympus.cafeteria.summary() }) },
      ...
      { method: "GET", pattern: "/v1/load-tests", handler: (_req, res) => res.json(200, { summary: this.olympus.loadTest.summary(), runs: this.olympus.loadTest.listRuns() }) },
      ...
      { method: "GET", pattern: "/v1/automations", handler: (_req, res) => res.json(200, { summary: this.olympus.automation.summary(), rules: this.olympus.automation.listRules(), deadLetters: this.olympus.automation.deadLetters() }) },
